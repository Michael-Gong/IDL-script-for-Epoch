...
b=dblarr(1800,1000,(endtime-starttime)/interval+1,nenpol)
bx=dblarr(1800,(endtime-starttime)/interval+1,nenpol)
by=dblarr(1000,(endtime-starttime)/interval+1,nenpol)
