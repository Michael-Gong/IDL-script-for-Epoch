...
a0=300.0
;for m=0,3 do begin
for n=0,132 do begin
x= 0.015*(n-34);0.05*m*6.666666
px=800*(sin(2*!pi*2*x[0]))
...
;endif else begin
;iplot,((x[*] mod 1)+1)mod 1,px[*],xrange=[0,1],yrange=[-1000,1000],rgb_table=39,vert_color=bytscl(t),linestyle=6,/overplot,symbol=3,sym_size=2
