...
electronrate[i-n1]=eenergy/(eenergy+protonenergy+phenergy)*(a.total_particle_energy-azc.total_particle_energy)/azc.total_field_energy
protonrate[i-n1]=protonenergy/(eenergy+protonenergy+phenergy)*(a.total_particle_energy-azc.total_particle_energy)/azc.total_field_energy
photonrate[i-n1]=phenergy/(eenergy+protonenergy+phenergy)*(a.total_particle_energy-azc.total_particle_energy)/azc.total_field_energy
endfor
