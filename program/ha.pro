...
device,decomposed=1
loadct,39
h0=sqrt(1+px1^2+a^2*4*(cos(2*!pi*x1))^2)
levels=findgen(1000)/1000*(max(h0)-min(h0))+min(h0)
for i=0,500 do begin
    h=sqrt(1+px1^2+a^2*4*(cos(2*!pi*x1))^2*(sin(2*!pi*i/100))^2)
    ...
    write_gif,'ha12.gif',tvrd(),delay_time=20,/multiple,repeat_count=0
