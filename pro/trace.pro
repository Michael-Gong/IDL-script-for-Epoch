...
script=where((abs(tracex) lt 4.0e-6) and (abs(tracey) lt 4.0e-6) and (sqrt(tracepx^2+tracepy^2+tracepz^2)/(m0*v0) gt 100.0) and (sqrt(tracepx^2+tracepy^2+tracepz^2)/(m0*v0) lt 300.0))
...
save,x,y,px,py,pz,filename='./trace.sav'
