...
if(max(levels) eq min(levels)) then continue 
...
plot,congrid(x[plotarea[0]:plotarea[1],i],500),congrid(b[plotarea[0]:plotarea[1],ny/2,i,n],500),thick=1.5,pos=[0.15,0.15,0.8,0.45],xstyle=5,ystyle=5,color=255,font=1
axis,yaxis=1,ystyle=9,charthick=1.5,charsize=1.2,ytitle='on-axis ekbar [m!E-3!N]',font=1
