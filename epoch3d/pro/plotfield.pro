...
plot,congrid(x[plotarea[0]:plotarea[1],i],500),congrid(field[plotarea[0]:plotarea[1],ny/2,i,n],500),thick=1.5,pos=[0.15,0.15,0.8,0.45],xstyle=5,ystyle=5,color=255,font=1
